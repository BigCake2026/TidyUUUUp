"""Render the v1.1.2 classic Dock in four representative states without a live desktop."""
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as temp_directory:
        ...
        # 01: classic compact composition.
        save_state(dock, "01_classic_compact.png")

        # 02: classic expanding search state.
        dock.set_dock_width(dock.stretched_width)
        dock.search_input.setMaximumWidth(360)
    ...
    print("Created v1.1.2 classic screenshot set")
