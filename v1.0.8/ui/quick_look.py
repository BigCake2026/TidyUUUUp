...
from PyQt5.QtWidgets import (
    ...
    QFrame, QGraphicsOpacityEffect, QScrollArea, QTextEdit, QApplication
)
...
class QuickLookPanel(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.file_icon.setStyleSheet("background: rgba(120, 130, 160, 0.06); border-radius: 10px; font-size: 24px;")
        ...
        self.filename_label.setStyleSheet("color: #1D1D1F; font-size: 15px; font-weight: 600; background: transparent;")
        self.filename_label.setWordWrap(True)
        info_layout.addWidget(self.filename_label)

        self.filepath_label = QLabel("")
        self.filepath_label.setStyleSheet("color: #6E6E73; font-size: 11px; background: transparent;")
        ...
        self.image_label.setStyleSheet("background: rgba(255, 255, 255, 0.85); border-radius: 12px;")
        ...
        default_text.setStyleSheet("color: #6E6E73; font-size: 13px; background: transparent;")
        ...
        self.size_label.setStyleSheet("color: #6E6E73; font-size: 11px; background: transparent;")
        meta_row.addWidget(self.size_label)

        self.mtime_label = QLabel("")
        self.mtime_label.setStyleSheet("color: #6E6E73; font-size: 11px; background: transparent;")
        ...
        tip_label.setStyleSheet("color: #6E6E73; font-size: 11px; background: transparent;")
    ...
    def show_panel(self, pos=None):
        """显示预览面板"""
        # 用 is not None 而非 if pos, 避免 QPoint(0,0) 被判为假
        if pos is not None:
