...
class FileItemWidget(QWidget):
    ...
    def _setup_ui(self):
        ...
        icon_label.setStyleSheet("background: rgba(120, 130, 160, 0.06); border-radius: 8px;")
        ...
        name_label.setStyleSheet("color: #1D1D1F; font-size: 13px; font-weight: 500;")
        ...
        meta_label.setStyleSheet("color: #6E6E73; font-size: 11px;")
...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        central = QWidget()
        central.setStyleSheet("background: rgba(250, 251, 255, 0.96);")
        ...
        logo_label.setStyleSheet("font-size: 22px; font-weight: 700; color: #1D1D1F;")
        ...
        # 分类标题
        cat_title = QLabel("分类")
        cat_title.setStyleSheet("color: #6E6E73; font-size: 11px; font-weight: 600; padding: 4px 8px;")
        ...
        self.stats_label.setStyleSheet("color: #6E6E73; font-size: 11px; padding: 8px;")
    ...
    def _setup_files_tab(self):
        ...
        sort_label.setStyleSheet("color: #3C3C43;")
        ...
        self.file_count_label.setStyleSheet("color: #6E6E73; font-size: 12px;")
    ...
    def _setup_organize_tab(self):
        ...
        strategy_label.setStyleSheet("color: #3C3C43;")
        ...
        self.subfolder_check.setStyleSheet("color: #1D1D1F;")
        options_row.addWidget(self.subfolder_check)

        self.dry_run_check = QCheckBox("模拟运行（不移动文件）")
        self.dry_run_check.setStyleSheet("color: #1D1D1F;")
        ...
        self.progress_label.setStyleSheet("color: #3C3C43; font-size: 12px;")
    ...
    def _add_dir_row(self, parent_layout, label_text, mode):
        ...
        label.setStyleSheet("color: #3C3C43;")
        row.addWidget(label)
    ...
    def _setup_duplicate_tab(self):
        ...
        dir_label.setStyleSheet("color: #3C3C43;")
        ...
        self.dup_images_only.setStyleSheet("color: #1D1D1F;")
        ...
        self.dup_progress_label.setStyleSheet("color: #3C3C43; font-size: 12px;")
    ...
    def paintEvent(self, event):
        ...
        painter.fillRect(self.rect(), QColor(250, 251, 255, 245))
